...
Alter  trigger tr_ActualizaDescuento
on FACTURAS after insert
as
...
select  @_nroFact=inserted.nroFact,
 ...
 begin
	...
	update CLIENTES set descuento=default where @_codCli=codCLi
 
 insert into FACTURAS values('007',2000,'2011-03-23','C02','Contado')
 insert into FACTURAS values('011',150,'2011-03-23','C03','Contado')
