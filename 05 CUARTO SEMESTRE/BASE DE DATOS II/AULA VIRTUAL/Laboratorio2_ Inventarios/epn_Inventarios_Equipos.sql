...
INSERT INTO registro.EQUIPO VALUES('3','2','1','Lenovo','Lenovo IdeaCentre B320','2014-10-12',450.9900)
INSERT INTO registro.EQUIPO VALUES('3','1','1','Lenovo','Lenovo IdeaCentre A720','2014-10-21',480.9900)
...
INSERT INTO mantenimiento.MANTENIMIENTO VALUES('2','3','2','2015-03-24')
INSERT INTO mantenimiento.MANTENIMIENTO VALUES('1','3','2','2015-04-10')
...
--Dar de baja
--Hacer un select de todos los registro i mando al historico

select *from epn_InventarioEquipos_Historico.mantenimiento.ESTADO_EQUIPO


select *from epn_Facturacion.dbo.detallefactura
select *from epn_Facturacion.dbo.producto